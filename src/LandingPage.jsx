...
const guides = [
  { section: 'Languages', items: [
    ...
    { slug: 'french', accent: '#1A237E', icon: '\u{1F1EB}\u{1F1F7}', title: 'Fran\u00e7ais', sub: 'Pronunciation, articles, verb tenses, pronouns, negation, and French culture \u2014 with audio.', count: '30 guides' },
    { slug: 'japanese', accent: '#D32F2F', icon: '\u{1F1EF}\u{1F1F5}', title: '\u65E5\u672C\u8A9E', sub: 'Hiragana, katakana, kanji, particles, verb forms, politeness levels, and cultural context.', count: '30 guides' },
    { slug: 'portuguese', accent: '#00695C', icon: '\u{1F1E7}\u{1F1F7}', title: 'Portugu\u00eas', sub: 'Brazilian Portuguese pronunciation, grammar, and verb tenses \u2014 with Spanish comparison notes throughout.', count: '30 guides' },
  ]},
  { section: 'Beyond Language', items: [
    ...
    { slug: 'music2', accent: 'linear-gradient(180deg, #7B1FA2, #1565C0)', icon: '\u{1F3BC}', title: 'Music Theory II', sub: 'Extended harmony, modulation, counterpoint, form analysis, orchestration, and 20th-century techniques \u2014 with playable audio.', count: '30 guides' },
    { slug: 'statistics', accent: 'linear-gradient(180deg, #E65100, #1565C0)', icon: '\u{1F4CA}', title: 'Statistics', sub: 'Descriptive stats, probability, distributions, hypothesis testing, regression, and data literacy \u2014 interactive visualizations.', count: '30 guides' },
    { slug: 'programming', accent: 'linear-gradient(180deg, #2E7D32, #1565C0)', icon: '\u{1F4BB}', title: 'Programming', sub: 'Variables, control flow, functions, data structures, algorithms, and patterns \u2014 visual, language-agnostic approach.', count: '30 guides' },
  ]},
];
