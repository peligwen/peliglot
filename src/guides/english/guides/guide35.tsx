...
export function Guide35(){
  const features=[
    ...
    {name:"Modales dobles",desc:"Might could = tal vez pueda. Might should = tal vez debería. Used to could = antes podía. Fixin' to = estoy a punto de. Son una construcción GRAMATICAL real con sus propias reglas — no combinaciones libres: 'Might you could help?' es incorrecto incluso en sureño; solo 'Might could you help?' o 'You might could help'. El inglés estándar solo permite UN modal, pero estos son sintaxis sureña productiva, no 'inglés roto'.",color:"#6A1B9A"},
