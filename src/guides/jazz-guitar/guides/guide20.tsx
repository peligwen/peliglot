...
export function Guide20(){return(<div>
  ...
  <Card color="#33691E" title="Essential turnaround types">
    {[{name:"Standard turnaround (I-vi-ii-V)",prog:"Cmaj7 → Am7 → Dm7 → G7",desc:"The default last 2 bars of a 32-bar standard. Often the vi is dominantized: Cmaj7 → A7 → Dm7 → G7, using A7 as the secondary dominant (V/ii) of Dm7.",color:"#81C784"},
