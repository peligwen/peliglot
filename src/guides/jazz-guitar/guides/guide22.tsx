...
export function Guide22(){return(<div>
  ...
  <Card color="#37474F" title="Right hand approaches">
    {[{tech:"Pick (plectrum)",desc:"Heavier picks (1mm+) for warmth and control. Pick closer to the neck for jazz warmth, closer to the bridge for brightness. Angle matters — less 'scratch,' more 'press.'",who:"Joe Pass, Pat Martino"},
      {tech:"Pick (light/hybrid)",desc:"Light pick attack or pick-and-fingers. Softer entry, cleaner dynamics, more textural range. Pick plus middle finger is common for chord melody and comping.",who:"Pat Metheny, John Scofield"},
    ...
    ].map((t,i)=>(<div key={i} style={{padding:"10px 14px",borderBottom:i<4?"1px solid #333":"none"}}>
