...
export function Guide19(){return(<div>
  ...
  <Card color="#1B5E20" title="Minor ii-V-i approaches">
    {[{approach:"Locrian #2 over iim7b5",line:"D locrian #2 (D-E-F-G-Ab-Bb-C) over Dm7b5",desc:"The natural 2 (E instead of Eb) makes the scale more melodic. Same as F melodic minor starting from the 6th degree (F-G-Ab-Bb-C-D-Eb → start on D)."},
