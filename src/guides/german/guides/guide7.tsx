...
export function Guide7(){
  ...
  const datPreps=[{p:"aus",m:"from/out of"},{p:"außer",m:"except for"},{p:"bei",m:"at/near"},{p:"gegenüber",m:"across from"},{p:"mit",m:"with"},{p:"nach",m:"after/to"},{p:"seit",m:"since"},{p:"von",m:"from/of"},{p:"zu",m:"to"}];
  ...
  return(<div>
    ...
    <div style={{fontSize:11,color:"#888",marginBottom:4,textAlign:"center"}}>Mnemonic: <strong>Aus bei mit nach seit von zu</strong> — mit dem Dativ nur so zu!</div>
    <div style={{fontSize:11,color:"#aaa",marginBottom:12,textAlign:"center"}}>+ <strong>außer</strong> (except for) · <strong>gegenüber</strong> (across from) — note: <em>gegenüber</em> often follows its noun: <strong>mir gegenüber</strong></div>
