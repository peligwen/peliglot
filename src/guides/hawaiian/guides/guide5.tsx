...
export function Guide5(){return(<div>
  <DarkBox title="Hawaiian is Verb-First"><div style={{fontSize:14,lineHeight:1.6}}>
    English: <strong>I am looking at the fish</strong> (SVO)<br/>
  ...
  <Insight text="Hawaiian has no separate copular verb 'to be'. Stative verbs carry the 'is quality' meaning (Nani ka pua = 'Is-beautiful the flower'), and equational frames carry the 'is the' meaning. The pattern itself conveys 'is' \u2014 no filler verb needed."/>
</div>);}
