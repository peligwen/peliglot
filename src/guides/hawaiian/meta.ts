...
export const guidesMeta: GuideMeta[] = [
  {id:1,title:"Ka Pīʻāpā",subtitle:"The Hawaiian Alphabet",cat:"Sounds",color:"#1B5E20",icon:"🌺"},
  {id:2,title:"Nā Wauela",subtitle:"Vowels & Diphthongs",cat:"Sounds",color:"#00695C",icon:"🔤"},
  {id:3,title:"Ka Puana ʻAna",subtitle:"Pronunciation & Syllables",cat:"Sounds",color:"#4527A0",icon:"🗣"},
  {id:4,title:"ʻOkina a me Kahakō",subtitle:"Glottal Stop & Macron",cat:"Sounds",color:"#C62828",icon:"ʻ"},
  {id:5,title:"Nā Papaʻōlelo",subtitle:"Basic Sentence Patterns",cat:"Sentences",color:"#0D47A1",icon:"📐"},
  ...
  {id:9,title:"Ka Hōʻole",subtitle:"Negation",cat:"Sentences",color:"#880E4F",icon:"✗"},
  {id:10,title:"Nā ʻAtikala",subtitle:"Articles & Definiteness",cat:"Nouns",color:"#2E7D32",icon:"📎"},
  {id:11,title:"O a me A",subtitle:"O-class vs A-class Possessives",cat:"Nouns",color:"#C62828",icon:"⚖️"},
  {id:12,title:"Koʻu / Kaʻu",subtitle:"Possessive Pronouns",cat:"Nouns",color:"#1565C0",icon:"👤"},
  ...
  {id:19,title:"Nā Haʻina ʻAʻano",subtitle:"Stative Verbs",cat:"Verbs",color:"#0D47A1",icon:"💭"},
  ...
  {id:28,title:"Nā ʻŌlelo Maʻamau",subtitle:"Common Phrases",cat:"Vocabulary",color:"#4527A0",icon:"💬"},
  {id:29,title:"Ka Hoʻōla ʻŌlelo",subtitle:"Language Revival",cat:"Culture",color:"#880E4F",icon:"🌱"},
  {id:30,title:"Pidgin a me ʻŌlelo Hawaiʻi",subtitle:"Pidgin vs Hawaiian",cat:"Culture",color:"#00695C",icon:"🗺"},
];

export const categories: string[] = ["Sounds","Sentences","Nouns","Pronouns","Verbs","Vocabulary","Culture"];

export const catColors: CategoryColors = {Sounds:"#1B5E20",Sentences:"#0D47A1",Nouns:"#C62828",Pronouns:"#00695C",Verbs:"#E65100",Vocabulary:"#4527A0",Culture:"#880E4F"};
