...
function PalNote({text}){return(<div style={{background:"#E8F5E9",borderRadius:10,padding:"10px 14px",marginBottom:12,border:"1px solid #C8E6C9",fontSize:12,color:"#2E7D32",lineHeight:1.5}}>{"\u{1F1F5}\u{1F1F8}"} <strong>Palestinian:</strong> {text}</div>);}
