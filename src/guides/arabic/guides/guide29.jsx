...
export function Guide29(){return(<div>
  ...
  <SimpleGuide items={[
    {h:"Major dialect families",b:"🇪🇬 Egyptian — historically the most widely understood due to its film and TV industry; Levantine and Gulf media have grown in reach\n🇵🇸🇱🇧🇸🇾🇯🇴 Levantine — Palestinian, Lebanese, Syrian, Jordanian\n🇸🇦🇦🇪🇰🇼 Gulf — Saudi, Emirati, Kuwaiti\n🇲🇦🇩🇿🇹🇳 Maghrebi — Moroccan, Algerian, Tunisian"},
