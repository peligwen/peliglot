...
export function Guide12(){return(<div>
  ...
  <SimpleGuide items={[
    ...
    {h:"Common broken plural patterns (Arabic-pattern notation)",b:"فُعُل: كتاب→كُتُب · فُعول: بيت→بُيوت\nأَفعال: ولد→أولاد · فِعال: رجل→رِجال\nفُعَلاء: وزير→وُزَراء"},
  ]}/>
  <Insight text="Non-human plurals take FEMININE SINGULAR agreement. كُتُب كبيرة (big books) — even though كتاب is masculine!"/>
  <PalNote text="Palestinian Arabic uses the same broken plurals as MSA. Sound masculine plural often becomes -īn for all cases: معلّمين (muʿallimīn)."/>
</div>);}
