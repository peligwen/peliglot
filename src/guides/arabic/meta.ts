...
export const categories: string[] = ["Writing","Phonology","Nouns","Pronouns","Verbs","Sentences","Practical"];

export const catColors: CategoryColors = {Writing:"#1B5E20",Phonology:"#880E4F",Nouns:"#C62828",Pronouns:"#1B5E20",Verbs:"#C62828",Sentences:"#0D47A1",Practical:"#1565C0"};
