    ...
    <div>
      ...
      <Card color="#C62828" title="The Key Questions">
        <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            { q: "Is AI output copyrightable?", a: "In most jurisdictions, pure AI output (with no human creative input) is not copyrightable. Human authorship is generally required.", icon: "\u{1F4C4}" },
            ...
            { q: "Who is liable for AI-generated content?", a: "Generally the person or company who deploys the AI and publishes the output, not the AI provider.", icon: "\u{1F46E}" },
          ].map((item, i) => (
