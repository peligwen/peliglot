...
export function Guide15(){return(<div>
  <DarkBox title="Multiple rhythmic layers"><div style={{fontSize:14}}>
    <strong style={{color:"#FFE77A"}}>Polyrhythm</strong> = two different rhythmic patterns at the same time (3 against 2, 4 against 3). <strong style={{color:"#FFE77A"}}>Odd meters</strong> = time signatures that don't divide evenly (5/4, 7/4, 7/8).
  </div></DarkBox>
  <Card color="#6A1B9A" title="Common polyrhythms & odd meters">
    {[{name:"3 against 2",desc:"One hand plays 3 even notes while the other plays 2. Found in Afro-Cuban music, West African drumming, jazz.",ex:"'Pass the god-damn but-ter' = 3 over 2"},
      ...
      {name:"7/4 time",desc:"7 quarter-note beats per bar, often felt as 2+2+3 or 3+4. A slow, walking seven — not the rapid eighth-pulse of true 7/8.",ex:"'Money' (Pink Floyd), Peter Gabriel 'Solsbury Hill'"},
      {name:"7/8 time",desc:"7 eighth notes per bar, rapid subdivisions. Heard in Balkan folk and prog rock.",ex:"Radiohead '2+2=5' (verse sections), much Balkan folk music"},
    ...
    ].map((p,i)=>(<div key={i} style={{padding:"10px 14px",borderBottom:i<4?"1px solid #f0eeeb":"none"}}>
