...
export function Guide12(){return(<div>
  ...
  <div style={{display:"grid",gridTemplateColumns:"repeat(2,1fr)",gap:8,marginBottom:16}}>
    {[{ts:"4/4",name:"Common Time",desc:"4 beats per bar. Vast majority of pop, rock, hip-hop, R&B, country.",pct:"~90% of popular music",color:"#E65100"},
      ...
      {ts:"6/8",name:"Compound Duple",desc:"2 groups of 3 eighth notes. Lilting swing feel — distinct from 3/4. Irish/folk songs, many ballads.",pct:"Folk, ballads",color:"#2E7D32"},
      {ts:"12/8",name:"Compound Quadruple",desc:"4 groups of 3 eighth notes. The slow-blues, gospel, and doo-wop feel. Sounds like a slow shuffle.",pct:"Slow blues, gospel, soul",color:"#6A1B9A"},
