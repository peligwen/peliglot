...
export function Guide8(){
  ...
  const centerline: GeoShape={type:"line",x1:160,y1:20,x2:160,y2:200,construction:isConstruction};
  return(<div>
    ...
    <SketchDiagram
      ...
      constraints={[{type:"vertical",at:{x:160,y:110}}] as SketchConstraint[]}
