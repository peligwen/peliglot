...
export function Guide30(){
  const pitfalls=[
    ...
    {name:"Self-intersecting profile",color:"#e74c3c",symptom:"Pad fails, possibly with no clear error. Profile looks correct from a distance",recovery:"Zoom way in to all corners. Find where two lines actually cross. Trim or delete the crossing segment. Check with Sketch > Validate Sketch."},
    ...
    {name:"Crash during long operation",color:"#e67e22",symptom:"FreeCAD closes unexpectedly during Loft, complex Pad, or mesh conversion",recovery:"Reopen the file — FreeCAD creates .FCBak backups. Go to Edit > Preferences > General > Backup to confirm backup count is ≥ 3. Save constantly with Ctrl+S."},
