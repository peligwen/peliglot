...
export function Guide14(){
  ...
  const symArrows=[{type:"line",x1:160,y1:180,x2:160,y2:115},{type:"line",x1:160,y1:180,x2:160,y2:245}];
  const arrows={
    0:symmetric?symArrows:[{type:"line",x1:160,y1:170,x2:160,y2:100}],
    1:symmetric?symArrows:[{type:"line",x1:160,y1:170,x2:160,y2:30}],
    2:[{type:"line",x1:160,y1:170,x2:160,y2:90},{type:"line",x1:160,y1:190,x2:160,y2:230}],
    3:[{type:"line",x1:160,y1:170,x2:160,y2:70}],
    4:[{type:"line",x1:160,y1:170,x2:160,y2:55}],
    5:[{type:"line",x1:160,y1:170,x2:160,y2:75},{type:"line",x1:90,y1:75,x2:230,y2:75}],
    6:[{type:"line",x1:160,y1:170,x2:160,y2:60},{type:"line",x1:80,y1:60,x2:140,y2:60},{type:"line",x1:180,y1:60,x2:240,y2:60}],
  };
  const arrowLabels={0:symmetric?"↑ N/2  ↓ N/2":"↑ N mm",1:symmetric?"↑/↓ all the way":"↑ all the way",2:"↑ more ↓ less",3:"↑ to first face",4:"↑ to last face",5:"↑ to picked face",6:"↑ to multiple faces"};
