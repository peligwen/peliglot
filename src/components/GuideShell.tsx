...
export function GuideShell({
  ...
  // Point all in-collection routes at the collection-level OG card.
  // Per-guide cards (public/og/<slug>-<id>.png) are not generated by default
  // (set PELIGLOT_GENERATE_GUIDE_OG=1 at build time to produce them).
  // Pointing at the collection card avoids 404 OG images on social previews.
  const ogImage = `https://peliglot.com/og/${slug}.png`;
